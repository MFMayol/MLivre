...
from LL_nuevas import LL_reparacion_factibilidad

class HiperHeuristica():
    '''Objeto que aplica el algoritmo'''
    def __init__(self, instancia = Instance, V = float, low_levels = list, solucion = Solucion):
        ...
        self.tiempo_maximo = time.time() + 60 # minutos maximos
