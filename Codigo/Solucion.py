...
class Solucion:
    ...
    def __str__(self):
        ...
        """
        return f"La solución escoje las ordenes {self.id_selected_orders} con un total de {self.total_units_orders} unidades y los corredores {self.id_selected_runners} con un valor objetivo de {self.objective_value:.2f}."
